...
class TestFraction(unittest.TestCase):
    ...
    def test_simplify(self):
        """verify the simplify function"""
        f1518: Fraction = Fraction(15, 18)
        f637: Fraction = Fraction(63, -7)
        f12: Fraction = Fraction(1, 2)

        self.assertEqual(str(Fraction.simplify(f1518)), str(Fraction(5.0, 6.0)))
        self.assertEqual(str(Fraction.simplify(f637)), str(Fraction(9.0, -1.0)))
        self.assertEqual(str(Fraction.simplify(f12)), str(Fraction(1.0, 2.0)))
